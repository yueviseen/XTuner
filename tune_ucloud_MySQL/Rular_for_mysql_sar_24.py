...
def param_innodb_change_buffer():
    ...
    return max_size, seg_size, merge_list[len(merge_list)-1] - merge_list[0], merge_op_list[len(merge_op_list)-1] + merge_dis_list[len(merge_dis_list)-1] - merge_op_list[0] - merge_dis_list[0]
